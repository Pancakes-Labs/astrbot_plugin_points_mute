...
- [ ] 🥳 我已阅读并同意遵守该项目的 [贡献指南](https://github.com/Pancakes-Labs/astrbot_plugin_points_mute/blob/main/CONTRIBUTING.md) / I have read and agree to abide by the [CONTRIBUTING](https://github.com/Pancakes-Labs/astrbot_plugin_points_mute/blob/main/CONTRIBUTING.md) of this project.
